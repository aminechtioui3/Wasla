      ...
      <div className="container-shell">
        ...
        >
          <div className="grid gap-6 xl:grid-cols-[0.95fr_1.05fr]">
            <div className="rounded-[28px] border border-white/10 bg-white/12 p-6 backdrop-blur">
              ...
              <div className="mt-6 rounded-[24px] border border-white/10 bg-white/12 p-5">
              ...
              <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
                {trustMetrics.map((metric) => {
                  ...
                  return (
                    <div
                      key={metric.label}
                      className="flex min-h-[118px] items-start gap-3 rounded-[22px] border border-white/10 bg-white/12 p-4 shadow-soft backdrop-blur"
                    >
                      <div className="inline-flex rounded-2xl bg-white/12 p-2.5 text-cream">
                        <Icon className="h-4 w-4" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-base font-extrabold text-white">{metric.value}</p>
                        <p className="mt-1 text-sm font-medium text-white/80">{metric.label}</p>
                      </div>
                    </div>
                  );
                })}
